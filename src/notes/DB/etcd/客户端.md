...
etcdctl get /spark --prefix --keys-only --user=root --password=xx

# 写入 key
etcdctl put /vena/common/metadata/currency '[{"code":"HKD","symbol":"HK$","icon":""},{"code":"USD","symbol":"$","icon":""}]' --user=root --password=xxx
